...
class UserActionsEntitiesServiceTest {
    ...
    private void buildAndInitializeMocksForCustomUserActionsEntity(String catalogItemId, List<CatalogItemEntityUserAction> userActions) throws InvalidIdException {
        ...
        when(catalogServiceAdapter.bitbucketPathAtFromId(catalogItemId)).thenReturn(catalogItemIdUserActionsPathAt);
        when(catalogServiceAdapter.getCatalogEntity(catalogItemIdUserActionsPathAt, CatalogItemEntity.class)).thenReturn(Optional.of(customUserActionsEntity));
